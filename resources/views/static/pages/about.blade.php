        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1
                    ...
                    On a mission to enable you to grow you audience more effectively.
                </h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-300">From
    ...
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                ...
                <p class="font-light text-gray-500 lg:mb-16 sm:text-xl ">Explore the whole collection
            ...
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex ">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mt-3 mb-4 font-light text-gray-500 ">Bonnie drives the technical
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex ">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mt-3 mb-4 font-light text-gray-500">Jese drives the technical
                            strategy of the flowbite platform and brand.</p>
                        <ul class="flex space-x-4 sm:mt-0">
                            <li>
                                <a href="#" class="text-gray-500 hover:text-gray-900 ">
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mt-3 mb-4 font-light text-gray-500 ">Michael drives the technical
                            strategy of the flowbite platform and brand.</p>
                        <ul class="flex space-x-4 sm:mt-0">
                            <li>
                                <a href="#" class="text-gray-500 hover:text-gray-900 ">
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex ">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mt-3 mb-4 font-light text-gray-500 ">Lana drives the technical
                            strategy of the flowbite platform and brand.</p>
                        <ul class="flex space-x-4 sm:mt-0">
                            <li>
                                <a href="#" class="text-gray-500 hover:text-gray-900 ">
